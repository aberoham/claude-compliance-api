...
type Actor struct {
	...
	// Service account and federated workload actor fields.
...
type ChatMessage struct {
	...
	GeneratedFiles []GeneratedFileReference `json:"generated_files,omitempty"`
	Artifacts      []ArtifactReference      `json:"artifacts,omitempty"`
}

type GeneratedFileReference struct {
	ID        string  `json:"id"`
